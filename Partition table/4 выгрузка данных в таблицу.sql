...
--выгружаем данные в текстовый файл
exec master..xp_cmdshell 'bcp "[WideWorldImporters].Sales.Orders" out  "c:\mssql2020\Orders.txt"  -T -w -t";" -S LAPTOP-8RGUNJN3\SQL2017'

--Добавляем данные из файла в созданную ранее таблицу
	BULK INSERT [WideWorldImporters].[Sales].[OrdersYears]
				   FROM "c:\mssql2020\Orders.txt"
				   WITH 
					 (
						BATCHSIZE = 1000, 
...
------------------select Count(*) AS Invoices from [Sales].[InvoicesYears];
